...
let person_name : string = "Qadeer afridi";

console.log(person_name.toLocaleLowerCase()); //lowercase
console.log(person_name.toUpperCase());//uppercase
// Title case 
function toTitleCase(str:string){
    return str.toLowerCase().split(' ').map(word =>{return word.charAt(0).toUpperCase() + word.slice(1);
    }).join(' ');
...
let famous_scientist:string = "Albert Einstein";
...
let Name_jd: string []= ["Khan", "Panjabi", "Sindhi",];
...
let names_Array: string[] = ["Alice", "Bob", "Charlie", "Diana", "Ethan"];
...
let motorcycle: string[] = ["Car", "honda", "civic", "vego"];
...
let guestList: string[] = ['Albert Einstein', 'Marie Curie', 'Nikola Tesla'];
...
let places_5:string []= ["afghanistan", "saudi", "palestine", "Sham", "Iraq"];
...
let cities: string[] = ["Tokyo", "Paris", "New York", "Sydney", "Rio de Janeiro"];
function printCities(city:string []){
...
console.log("you just earn 15 pounts");
 ...
 // for yellow colour
 let aliener_color: string = "yellow";
...
let current_users: string[] = ['admin', 'Eric', 'John', 'Alice', 'Sarah'];
let new_users: string[] = ['john', 'Mike', 'eric', 'Tom', 'Emily'];
...
function make_shirtA(size: string = 'L', message: string = 'I love TypeScript') {
...
function descripr_city(city:string, country:string ='Pakistan'){
...
return album;
 ...
 function show_magicianses(magicians: string[]) {
     for (let magician of magicians) {
         console.log(magician);
     }
 }
 
 function make_great_magicians(magicians: string[]): string[] {
